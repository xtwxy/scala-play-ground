...
object Dependencies {
  ...
  lazy val driverGroupName       = "com.wincom.ecommerce.driver"
  lazy val artifactVersionNumber = "1.0.0"
  lazy val ecommerceGroupName         = "com.wincom.ecommerce"
  lazy val ecommerceVersionNumber     = "1.0.0"
  lazy val sprayVersion          = "1.3.3"
  lazy val playVersion           = "2.6.9"
  lazy val playSilhouetteVersion = "5.0.3"

  lazy val scalaXml        = "org.scala-lang.modules"    %%  "scala-xml"                          % "1.0.6"
  lazy val ecommerceMessage     = ecommerceGroupName               %%  "message"                            % ecommerceVersionNumber
  lazy val ecommerceDomain      = ecommerceGroupName               %%  "domain"                             % ecommerceVersionNumber
  lazy val ecommerceService     = ecommerceGroupName               %%  "service"                            % ecommerceVersionNumber
  lazy val ecommerceRest        = ecommerceGroupName               %%  "rest"                               % ecommerceVersionNumber
